...
* **Coverage:** Test behavior and domain invariants, not implementation details. Security tests must follow the **OWASP Testing Guide** as the reference standard for what to cover and how to approach security validation.
