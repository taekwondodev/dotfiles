...
**Balance:** The bar is triviality, not repetition. A one-off still earns a lever when the lever is what makes the work checkable. Per the [Laziness Protocol](../principle-laziness-protocol/SKILL.md), build the smallest script that does or proves the job, never a framework. A lever is bounded by the work it serves: when the lever's own code, tests, or evidence outgrow the change it does or proves, the lever has become the project. Stop, and ask the user whether they want that project.
