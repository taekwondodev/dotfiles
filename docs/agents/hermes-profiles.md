...
| --- | --- | --- |
| `apple-dev` | `config.yaml`, `profile.yaml`, `SOUL.md`, `assets/avatar.png` | `.env`, auth, chat history, session dumps, profile-local bundled skills, cron runtime, memory, state database, caches |
