...
* Invoke `/design` skill when: designing a new feature, creating a new module, creating a new class, or doing structural refactoring.

## 5. Testing Strategy
* Invoke `/testing` skill when: writing tests or setting up a test suite.
