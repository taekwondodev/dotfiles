...
- **Feature Envy**: a method that reaches into another object's data more than its own. This signals it's living in the wrong `/design` layer. → move the method onto the data it envies.
